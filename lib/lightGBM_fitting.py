...
def lgb_modelfit_nocv(dtrain, dvalid, predictors, target='target', objective='binary', metrics='auc',
                 feval=None, early_stopping_rounds=30, num_boost_round=1000, verbose_eval=True, categorical_features=None):
    ...
    lgb_params = {
        ...
        'num_leaves': 7,  # 31 # 200
        'max_depth': 4,  # -1 means no limit # 8 
        ...
        'colsample_bytree': 0.7,  # Subsample ratio of columns when constructing each tree. #0.9
